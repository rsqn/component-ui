...
tech.rsqn.core.UIComponent.prototype.getId = function () {
    if (this.seq == 0) {
...
tech.rsqn.core.UIComponent.prototype.__initComponents = function () {
    var self = this;
...
tech.rsqn.core.UIComponent.prototype.initDecorator = function (container) {
    this.container = container;
    this.myElement = container;
};

tech.rsqn.core.UIComponent.prototype.find = function (selector) {
    return this.myElement.find(selector);
};

tech.rsqn.core.UIComponent.prototype.bindNavigationListeners = function (pageName, path, onNavInCb, onNavOutCb, onLoadCb) {
    var self = this;
...
tech.rsqn.core.UIComponent.prototype.simpleSelect2 = function (url, selector, vc, _opts) {
    var self = this;
    $.ajax({
            type: "GET",
            cache: false,
...
tech.rsqn.core.UIComponent.prototype.attachList = function (url, selector, vc, _opts) {
    var self = this;
    var cache = {};
...
// Deprecated
//tech.rsqn.core.UIComponent.prototype.onPostFailure = function (jqXHR, textStatus, errorThrown) {
//    if (jqXHR.status == 500 || jqXHR.status == 0) {
//        notify.fatalNotification("System Error", "Sorry something went wrong, Please try again later.");
//    } else {
//        if (jqXHR.status == 400) {
...
tech.rsqn.core.UIComponent.prototype.stdFail = function () {
    var self = this;
...
tech.rsqn.core.UIComponent.prototype.onServerValidationFailed = function (result, model) {
